...
- CoreWebView2ProcessFailedEventArgs.CrashReport
...
Members|Description
--|--
[CrashReport](#crashreport) | The [CoreWebView2CrashReport](corewebview2crashreport.md) for this process failure, or `null` if no crash report is available (normal exit, external kill, launch failure, hang, or crash-type failure that produced no report).
...
> readonly  [CoreWebView2CrashReport](corewebview2crashreport.md) CrashReport

The [CoreWebView2CrashReport](corewebview2crashreport.md) for this process failure, or `null` if no crash report is available (normal exit, external kill, launch failure, hang, or crash-type failure that produced no report).

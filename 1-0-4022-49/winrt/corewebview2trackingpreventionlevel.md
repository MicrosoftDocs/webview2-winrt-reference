...
The default value is CoreWebView2EnhancedSecurityModeLevel.Off (unresolved reference).
...
See CoreWebView2EnhancedSecurityModeLevel (unresolved reference) for descriptions of levels.
Changes apply immediately to new navigation. Existing pages require a reload for the change to take effect.

The EnhancedSecurityModeLevel setting is not persisted in the user data folder. It resets to the default value of CoreWebView2EnhancedSecurityModeLevel (unresolved reference).Off when the profile is destroyed and recreated.|

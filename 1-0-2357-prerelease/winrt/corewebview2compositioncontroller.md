...
[QueryNonClientRegion](#querynonclientregion) | When a given <param name="Kind"> region kind of type <see cref="CoreWebView2NonClientRegionKind" /></param>
...
When a given <param name="Kind"> region kind of type <see cref="CoreWebView2NonClientRegionKind" /></param>
